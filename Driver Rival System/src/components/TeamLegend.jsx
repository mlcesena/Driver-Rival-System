    ...
    return (
        <div className='comparison-names'>
            <div>
                ...
                <h2 className='driver-acronym' style={{ margin: 0 }}>{teams.size > 0 && firstTeamName !== "" ? teams.get(firstTeamName).name : "---"}</h2>
            </div>
            <div style={{ marginLeft: "auto" }}>
                <h2 className='driver-acronym' style={{ marginBottom: 0 }}>{teams.size > 0 && secondTeamName !== "" ? teams.get(secondTeamName).name : "---"}</h2>
